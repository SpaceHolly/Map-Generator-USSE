...
public sealed class GenerationSettings
{
    ...
    [SettingMetadata(Importance = SettingImportance.Required, Category = SettingCategory.Grid, DisplayName = "Seed", Description = "Случайное зерно", Min = "0", Max = "2147483647", Step = "1")]
